      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-white">Monte-Carlo</span>
          ...
          <div className="hidden md:flex items-center space-x-1">
            <Link
              href="/chatbot"
              className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all duration-200 flex items-center space-x-2"
            >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${
                      isConnected 
                        ...
                        : "bg-blue-400 hover:bg-blue-500 text-white shadow-lg hover:shadow-xl hover:scale-105"
                    }`}
                  >
                    {isConnected ? (
                      <div className="flex items-center space-x-2">
